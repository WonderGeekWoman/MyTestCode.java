...
public class HeightConverterZBSlider extends JFrame implements ActionListener, ChangeListener {
   ...
   public static void main(String[] args) {
      ...
      HeightConverterZBSlider myFrame = new HeightConverterZBSlider();
