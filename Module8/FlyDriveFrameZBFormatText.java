...
public class FlyDriveFrameZBFormatText extends JFrame implements ActionListener {
   ...
   public static void main(String[] args) {
      ...
      FlyDriveFrameZBFormatText myFrame = new FlyDriveFrameZBFormatText();
