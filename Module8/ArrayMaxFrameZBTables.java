...
public class ArrayMaxFrameZBTables extends JFrame implements ActionListener {
   ...
   public static void main(String[] args) {
      ...
      ArrayMaxFrameZBTables myFrame = new ArrayMaxFrameZBTables();
