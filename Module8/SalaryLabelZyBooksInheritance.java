...
public class SalaryLabelZyBooksInheritance extends JFrame {
   ...
   /* Constructor initializes the SalaryLabelZyBooksInheritance, 
      creates GUI components, and adds them
      using a GridBagLayout. */
   public SalaryLabelZyBooksInheritance() {
   ...
   /* Creates a SalaryLabelZyBooksInheritance and makes it visible */
   public static void main(String[] args) {
      // Creates SalaryLabelFrame and its components
      SalaryLabelZyBooksInheritance myFrame = new SalaryLabelZyBooksInheritance();
