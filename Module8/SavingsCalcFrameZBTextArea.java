...
public class SavingsCalcFrameZBTextArea extends JFrame implements ActionListener {
   ...
   public static void main(String[] args) {
      ...
      SavingsCalcFrameZBTextArea myFrame = new SavingsCalcFrameZBTextArea();
