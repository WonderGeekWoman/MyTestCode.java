...
public class DogYearsFrameZBSpinner extends JFrame implements ChangeListener {
   ...
   public static void main(String[] args) {
      ...
      DogYearsFrameZBSpinner myFrame = new DogYearsFrameZBSpinner();
